<template>
  <div>
    ...
    <p>You can visit the app <strong><a href="https://bit.ly/datavisapp">https://bit.ly/datavisapp</a></strong>.</p>
    <p>The source code is available on <strong><a href="https://github.com/AnandChowdhary/datavis">GitHub</a></strong> under the MIT License.</p>
  </div>
</template>
